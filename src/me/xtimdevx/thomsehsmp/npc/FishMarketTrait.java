...
@TraitName("fishmarket")
public class FishMarketTrait extends Trait {

    private Logger logger;
    

    public FishMarketTrait() {
        super("fishmarket");
    ...
    public void click(NPCRightClickEvent event) {
        if (event.getNPC() == this.getNPC()) {
            ...
            FishMarket.openMarketRedstone(player);
        }
    }
