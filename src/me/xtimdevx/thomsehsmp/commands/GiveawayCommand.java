    ...
    public boolean onCommand(CommandSender sender, org.bukkit.command.Command cmd, String label, final String[] args) {
        ...
        if (args[0].equalsIgnoreCase("rank")) {
            ...
            for (Player all : Bukkit.getOnlinePlayers()) {
                all.sendMessage("§9§lGiveaway §8> §9" + online.getName() + " §fhas won the §6§lGold §frank with a giveaway!");
            }
        }
        if (args[0].equalsIgnoreCase("crate")) {
            ...
            for (Player all : Bukkit.getOnlinePlayers()) {
                all.sendMessage("§9§lGiveaway §8> §9" + online.getName() + " §fhas won the §6§lDaily §fcrate key with a giveaway!");
            }
            ...
            lore.add("§8§m-------------------------");
            lore.add("§fRight-click on the §3Daily Crate");
            lore.add("§fTo get your rewards.");
