...
@TraitName("ash")
public class AshTrait extends Trait {
    ...
    public void click(NPCRightClickEvent event) {
        if (event.getNPC() == this.getNPC()) {
            ...
            marketMethods.marketNPCMessage(MarketMethods.MarketNPC.ASH, player, "Gotta Train em all! Meet my Puffachu.");
