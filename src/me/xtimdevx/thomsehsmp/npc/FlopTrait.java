...
@TraitName("flop")
public class FlopTrait extends Trait {
    ...
    public void click(NPCRightClickEvent event) {
        if (event.getNPC() == this.getNPC()) {
            ...
            marketMethods.marketNPCMessage(MarketMethods.MarketNPC.FLOP, player, "Lalalalala lalalalalala lala lalalalalala.");
