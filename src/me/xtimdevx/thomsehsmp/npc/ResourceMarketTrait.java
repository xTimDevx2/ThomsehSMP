...
@TraitName("resourcemarket")
public class ResourceMarketTrait extends Trait {

    private Logger logger;

    public ResourceMarketTrait() {
        super("resourcemarket");
    ...
    @Persist("resourcemarketsettings")
