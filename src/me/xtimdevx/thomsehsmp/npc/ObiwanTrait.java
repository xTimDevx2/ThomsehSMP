...
@TraitName("obiwan")
public class ObiwanTrait extends Trait {
    ...
    public void click(NPCRightClickEvent event) {
        if (event.getNPC() == this.getNPC()) {
            ...
            marketMethods.marketNPCMessage(MarketMethods.MarketNPC.OBIWAN, player, "Konnichiwa There!");
        }
    }
