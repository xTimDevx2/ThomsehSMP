...
@TraitName("thomseh")
public class ThomsehTrait extends Trait {
    ...
    public void click(NPCRightClickEvent event) {
        if (event.getNPC() == this.getNPC()) {
            ...
            marketMethods.marketNPCMessage(MarketMethods.MarketNPC.THOMAS, player, "OOH NEEEEE!!! *SLAMS DESK*");
