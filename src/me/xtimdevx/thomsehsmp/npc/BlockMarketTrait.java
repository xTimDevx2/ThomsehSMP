...
@TraitName("blockmarket")
public class BlockMarketTrait extends Trait {
    ...
    public void click(NPCRightClickEvent event) {
        if (event.getNPC() == this.getNPC()) {
            ...
            BlockMarket.openMarketRedstone(player);
        }
    }
